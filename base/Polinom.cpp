...
double Polinom::Calculation(std::map<std::string, double> values)
{
	double result = 0.0;
...
Polinom Polinom::Differentiation(std::string variable)
{
...
Polinom Polinom::Integration(std::string variable)
{
...
std::vector<std::string> Polinom::GetAllVariables()
{
...
bool Polinom::CheckOfVariable(std::string variable)
{
	if ((((variable.find_first_of("0123456789") > variable.find_last_not_of("0123456789"))
		&& (variable.find_first_of(".,<>?/|!@#$&={}[]:;\"'") == std::string::npos))))
	{
